...
public class Main_BookData_C {
    ArrayList<Main_BookListData_C> items = new ArrayList<>();

    public ArrayList<Main_BookListData_C> getData(AssetManager assetManager, String BookType) {
        ...
        try {
            ...
            for (int i = 0; i < flag.length(); i++) {
                ...
                items.add(new Main_BookListData_C(Writer, Title, BookImg, Intro));
            }
