...
public class TestAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.main_booklist_test, parent, false);
            return new TestAdapter.Main_BookListViewHolder_New(view);
        } else {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.spinner, parent, false);
            return new TestAdapter.LoadingViewHolder(view);
        }
    }
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof TestAdapter.Main_BookListViewHolder_New) {
            populateItemRows((TestAdapter.Main_BookListViewHolder_New) holder, position);
        } else if (holder instanceof TestAdapter.LoadingViewHolder) {
            showLoadingView((TestAdapter.LoadingViewHolder) holder, position);
        }
    }
    ...
    private void showLoadingView(TestAdapter.LoadingViewHolder holder, int position) {
