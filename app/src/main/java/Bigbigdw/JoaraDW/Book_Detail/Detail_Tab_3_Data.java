...
public class Detail_Tab_3_Data {
    ...
    public ArrayList<Main_More_ListData> getData(RequestQueue queue, LinearLayout Wrap, String BookCode, String Value) {
                ...
                for (int i = 0; i < JSONLength; i++) {
                    ...
                    switch (Value) {
                        ...
                        case "SETTING_PAGE":
                            ...
                            items.add(new Main_More_ListData(Title, Date, SortNoText, ""));
                            break;
                        case "SURVEY":
                        case "SURVEY_PAGE":
                            ...
                            if(Value.equals("SURVEY_PAGE")){
                                ...
                                items.add(new Main_More_ListData(Title, SurveyDateTotal, "", SurveyStatus));
                            } else {
                                items.add(new Main_More_ListData(Title, SurveyEnd, "", SurveyStatus));
                            }
