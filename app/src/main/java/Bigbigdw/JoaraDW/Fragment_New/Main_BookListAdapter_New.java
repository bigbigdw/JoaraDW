...
public class Main_BookListAdapter_New extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnClickFavListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_ITEM) {
            ...
            return new Main_BookListAdapter_New.Main_BookListViewHolder_New(view, this);
        } else {
    ...
    @Override
    public void onItemClick(Main_BookListViewHolder_New holder, View view, int position, String Value) {
        if (listener != null) {
