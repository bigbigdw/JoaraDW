...
class FragmentGenreTabPage : Fragment() {
    ...
    override fun onCreateView(
        ...
        val root = inflater.inflate(R.layout.activity_genre, container, false)
        ...
        tabviewmodel!!.text.observe(viewLifecycleOwner, { tabNum: String? ->
            when (tabNum) {
                ...
                "TAB13" -> {
                    category = "60,11,7,15,8,14"
                }
                else -> {
                    category = "50,10,18,13,16,17"
                }
            }
            setLayout()
        })
    ...
    fun setLayout() {
        ...
        adapterFirst = AdapterGenreTabs(requireContext(),items1, category)
        adapterSecond = AdapterGenreTabs(requireContext(),items2, category)
        adapterThird = AdapterGenreTabs(requireContext(),items3, category)
    ...
    companion object {
        ...
        fun newInstance(index: Int): FragmentGenreTabPage {
            val fragment = FragmentGenreTabPage()
            val bundle = Bundle()
