...
public class Fragment_Joara_Post_List extends Fragment {
    int tabNum = 0;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Fragment_Joara_Post_List.SectionsPagerAdapter sectionsPagerAdapter = new Fragment_Joara_Post_List.SectionsPagerAdapter(getContext(), getChildFragmentManager());
