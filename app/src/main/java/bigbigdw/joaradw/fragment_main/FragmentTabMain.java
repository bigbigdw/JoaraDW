...
public class FragmentTabMain extends BookBaseFragment implements InterfaceMainBannerAPI {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_tab_main, container, false);
    ...
    public void setLayout(View root) {
        ...
        wrap77Fes.setOnClickListener(v -> gotoMore(1, R.id.action_Fragment_Main_to_Fragment_New, FragmentTabMain.this));
        wrapKidamu.setOnClickListener(v -> gotoMore(2, R.id.action_Fragment_Main_to_Fragment_New, FragmentTabMain.this));
        wrapNOTY.setOnClickListener(v -> gotoMore(3, R.id.action_Fragment_Main_to_Fragment_New, FragmentTabMain.this));
        wrapPromised.setOnClickListener(v -> gotoMore(4, R.id.action_Fragment_Main_to_Fragment_New, FragmentTabMain.this));
        goToHistory.setOnClickListener(v -> gotoMore(1, R.id.action_Fragment_Main_to_Fragment_Fav, FragmentTabMain.this));
        goToFes.setOnClickListener(v -> gotoMore(1, R.id.action_Fragment_Main_to_Fragment_New, FragmentTabMain.this));
        goToPromised.setOnClickListener(v -> gotoMore(4, R.id.action_Fragment_Main_to_Fragment_New, FragmentTabMain.this));
        goToKidamu.setOnClickListener(v -> gotoMore(2, R.id.action_Fragment_Main_to_Fragment_New, FragmentTabMain.this));
        goToNoty.setOnClickListener(v -> gotoMore(3, R.id.action_Fragment_Main_to_Fragment_New, FragmentTabMain.this));
